...
The browser based version will allow you to edit fields prior to generating the CSV and it comes bundled with [QuillJS](http://quilljs.com) to enable rich text editing. All fields will be editable however only fields name **body** will be presented with the toolbar.
